            ...
            <div id="layoutSidenav_content">
                <main>
                        <div class="row" style="margin-top: 40px; margin-left: 20px">
                            <div>                        
                            <form action="result_addKH.php" method="get">
        <h1> Thêm khách hàng</h1>
        <p>Khách hàng ID</p> <input type="text" name="khach_hang_id">
        <p>Họ và tên</p> <input type="text" name="ho_ten_kh">
        <p>Số điện thoại</p> <input type="text" name="sdt"><br> <br>
