            ...
            <div id="layoutSidenav_content">
                <main>
                        <div class="row" style="margin-top: 40px; margin-left: 20px">
                            <div>                        
                            <form action="result_addMA.php" method="get">
        <h1> Thêm món ăn</h1>
        <p>Tên món ăn</p> <input type="text" name="ten_mon_an">
        <p>Giá tiên</p> <input type="text" name="gia_tien">
        <p>Mô tả</p> <input type="text" name="mo_ta"><br> <br>
