            ...
            <div id="layoutSidenav_content">
                <main>
                        <div class="row" style="margin-top: 40px; margin-left: 20px">
                            <div>                        
                            <form action="result_add.php" method="get">
        <h1> Thêm nhân viên</h1>
        <p>Nhân viên ID</p> <input type="text" name="id">
        <p>Họ và tên</p> <input type="text" name="ho_ten">
        <p>Số điện thoại</p> <input type="text" name="sdt">
        <p>CCCD</p> <input type="text" name="CCCD"> <br><br>
