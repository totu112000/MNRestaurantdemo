...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div style="margin-top: 100px; margin-left:250px" id="layoutSidenav_content">
                <main>
...
if($row["ten_mon_an"]== 0)
{
echo"<tr class='odd'><td>".$row['ten_mon_an']."</td>";
}
else 
{
echo "<tr class='even'><td>".$row['ten_mon_an']."</td>";

}
echo "<td>".$row['gia_tien']."</td>".
   "<td>".$row['mo_ta']."</td>".
   "<td>"."<form action='DeleteMA.php' method='get'><input type='submit' value='Xóa' name='id'></form>
   "."</td>".
   "<td>"."<form action='UpdateMA.php' method='get'><input type='submit' value='Sửa' name='id'></form>
   "."</td>
   </tr>";
}
?>
