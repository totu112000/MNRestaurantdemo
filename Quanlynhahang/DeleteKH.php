            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Chọn khách hàng muốn xóa</h1>
                        <form action="delete_resultKH.php" method="get">
        <select name="id">
        <?php
              ...
              for($i = 0; $i<$result->num_rows; $i++)
              {
                ...
                $sdt = $row['sdt'];
                echo "<option value='$id'>ID: $id - Tên: $ho_ten - SĐT: $sdt </option>";
              }

              $conn->close(); 
         ?>
         </select>
         <input type="submit" value="Delete"  onclick=" return confirm ('Bạn có thật sự muốn xoá');">
                            </div>
