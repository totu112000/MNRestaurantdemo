            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <form action="result_updateKH.php" method="get">
...
$sql = "SELECT * FROM khach_hang WHERE khach_hang_id ='$id'";
...
echo"<input type='text' name='khach_hang_id' value='$id'><br>".
"<input type='text' name='ho_ten_kh' value='$ho_ten'><br>".
