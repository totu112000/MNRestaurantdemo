            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Sửa thông tin món</h1>
                        <form action="result_updateMA.php" method="get">
...
$sql = "SELECT * FROM mon_an WHERE ten_mon_an ='$ten_mon_an'";

$result = $conn->query($sql);

echo "<h1> $ten_mon_an</h1>";

$row = $result->fetch_assoc();
$gia_tien= $row['gia_tien'];
$mo_ta= $row['mo_ta'];

echo"<input type='text' name='ten_mon_an' value='$ten_mon_an'><br>".
"<input type='text' name='gia_tien' value='$gia_tien'><br>".
"<input type='text' name='mo_ta' value='$mo_ta'><br>";
