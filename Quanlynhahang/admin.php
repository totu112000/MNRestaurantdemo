...
if($row["Uid"]%2 == 0)
{
echo"<tr class='odd'><td>".$row['Uid']."</td>";
}
else 
{
echo "<tr class='even'><td>".$row['Uid']."</td>";
...
echo "<td>".$row['firstname']."</td>".
   ...
   "<td>".$row['password']."</td>".
   "<td>".$row['sdt']."</td>".
   "<td>"."<form action='DeleteAD.php' method='get'><input type='submit' value='Xóa' name='id'></form>
   "."</td>".
   "<td>"."<form action='UpdateAD.php' method='get'><input type='submit' value='Sửa' name='id'></form>
   "."</td>
   </tr>";
}
?>
