            ...
            <div id="layoutSidenav_content">
                <main>
                        <div class="row" style="margin-top: 40px; margin-left: 20px">
                            <div>                        
                            <form action="hoadon_result.php" method="get">
        <h1> Đặt món</h1>
        <p>Khách hàng</p> <select name="idKH">
        <?php
              ...
              for($i = 0; $i<$result->num_rows; $i++)
              {
                ...
                $ho_ten = $row['ho_ten_kh'];

                echo "<option value='$id'>ID: $id  Tên: $ho_ten </option>";
              }

              $conn->close(); 
         ?>
         </select>
        <p>Món ăn</p><select name="idMA">
        <?php
              require 'Connect_nhanvien.php';
              mysqli_set_charset($conn, 'UTF8');
              ...
              for($i = 0; $i<$result->num_rows; $i++)
              {
                ...
                $mo_ta = $row['mo_ta'];
                echo "<option value='$ten_mon_an'> $ten_mon_an - $mo_ta </option>";
              }

              $conn->close(); 
         ?>
         </select>
        <p>Số lượng</p> <input type="text" name="soluong">
        <p>Nhân viên phục vụ</p> <select name="idNV">
        <?php
              require 'Connect_nhanvien.php';
              mysqli_set_charset($conn, 'UTF8');
              ...
              for($i = 0; $i<$result->num_rows; $i++)
              {
                ...
                $ho_ten = $row['ho_ten'];
                echo "<option value='$nhan_vien_id'> ID: $nhan_vien_id -  $ho_ten </option>";
              }
