            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">TỔNG QUAN KINH DOANH</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Dashboard</li>
                        </ol>
                        <div class="row">
                            <select name="Major" style="width: 300px;height: 35px;margin-left: 20px">
                                <option value="td">Hôm nay</option>
                                <option value="ytd">Hôm qua</option>
                                <option value="tw">Tuần này</option>
                                <option value="tt">Tháng này</option>
                                <option value="ty">Năm này</option>

                            </select>
                            <select name="Major" style="width: 300px;height: 35px; margin-left: 20px">
                                <option value="kss">Không so sánh</option>
                                <option value="gdt">Giai đoạn trước</option>
                                <option value="cktt">Cùng kỳ tuần trước</option>
                                <option value="cktht">Cùng kỳ tháng trước</option>
                                <option value="cknt">Cùng kỳ năm trước</option>
                            </select>
                        </div>
