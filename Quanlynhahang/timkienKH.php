...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <form style="margin-left: 1000px;" action="timkienKH.php" method="get">
        <input type="text" name="timkiem" placeholder="Nhập họ tên hoặc ID">
        <input type="submit" name="" id="" value="TÌM KIẾM">
              ...
              $sql = "SELECT * FROM khach_hang WHERE ho_ten_kh = '$timkiem' OR khach_hang_id ='$timkiem' ";
    ...
    <th> </th>
        ...
        {
        if($row["khach_hang_id"]%2 == 0)
        {
         echo"<tr class='odd'><td>".$row['khach_hang_id']."</td>";
        }
        else 
        {
         echo "<tr class='even'><td>".$row['khach_hang_id']."</td>";

        }
        echo "<td>".$row['ho_ten_kh']."</td>".
        "<td>".$row['sdt']."</td>".
        "<td>"."<form action='DeleteKH.php' method='get'><input type='submit' value='Xóa' name='id'></form>
        "."</td>".
        "<td>"."<form action='UpdateKH.php' method='get'><input type='submit' value='Sửa' name='id'></form>
        "."</td>
        </tr>";
      }
        ?>
