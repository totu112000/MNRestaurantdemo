...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <form style="margin-left: 1000px;" action="timkienNV.php" method="get">
        ...
        <input type="submit" name="" id="" value="TÌM KIẾM">
              ...
              $sql = "SELECT * FROM nhan_vien WHERE ho_ten = '$timkiem' OR nhan_vien_id ='$timkiem'";
    ...
    <table border="1" width="100%" style="text-align:center; border-color:black">
        ...
        {
        if($row["nhan_vien_id"]%2 == 0)
        {
         echo"<tr class='odd'><td>".$row['nhan_vien_id']."</td>";
        }
        else 
        {
         echo "<tr class='even'><td>".$row['nhan_vien_id']."</td>";

        }
            echo "<td>".$row['ho_ten']."</td>".
                 "<td>".$row['sdt']."</td>".
                 "<td>".$row['CCCD']."</td>".
                 "<td>"."<form action='DeleteNV.php' method='get'><input type='submit' value='Xóa' name='id'></form>
                 "."</td>".
                 "<td>"."<form action='UpdateNV.php' method='get'><input type='submit' value='Sửa' name='id'></form>
                 "."</td>
                 </tr>";
      }
        ?>
